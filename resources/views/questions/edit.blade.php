            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="/questions/{{$question->id}}" method="post" class="form-group">
                            {!! method_field('PATCH') !!}
                            {!! csrf_field() !!}
                            <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                <label for="title">标题</label>
                                <input class="form-control" type="text" name="title" placeholder="标题" id="title" value="{{$question->title}}">
                                @if ($errors->has('title'))
